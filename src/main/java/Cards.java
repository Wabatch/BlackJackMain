...
public class Cards {
    ...
    private List<Cards> setAllDeck(){
        ...
        //petla tworzy nazwy kart na podstawie indeksow "i" i "j"  i przypisuje wartosci z powyzszych hashmap
        //przypisuje wartosci na podstawie algorytmu i przypisuje index zwiekszajac sie za kazdym wykonaniem petli wewnetrznej
        for(int i = 1; i < 14; i++){
            for(int j = 1; j < 5; j++){
                index++;
                if(i == 1)
